...
const LANGS = {
  'pt-BR': {
    ...
    strings: {
      ...
      settingsLang: 'Idioma',
      settingsView: 'Visualização',
      lblTriggers: 'Exibir triggers',
      lblProcs: 'Exibir procedures e functions',
      lblHideComments: 'Ocultar comentários do SQL',
  ...
  'en': {
    ...
    strings: {
      ...
      lblTriggers: 'Show triggers',
      lblProcs: 'Show procedures and functions',
      lblHideComments: 'Hide SQL comments',
  ...
  'fr': {
    ...
    strings: {
      ...
      lblTriggers: 'Afficher les triggers',
      lblProcs: 'Afficher les procédures et fonctions',
      lblHideComments: 'Masquer les commentaires SQL',
  ...
  'tlh': {
    ...
    strings: {
      ...
      settingsTitle: 'SeHlaw',
      settingsLang: 'Hol',
      settingsView: 'leghmeH',
      lblTriggers: 'triggers tI\'ang',
      lblProcs: 'procedures tI\'ang',
      lblHideComments: 'SQL QInmey tISo\'',
      lblComments: 'QInmey',
      close: 'yISoQmoH',
